        ...
        >
          ...
          <div class="middleDiv">
            <div
              ...
              style={{ width: "1150px", height: "180px" }}>
                <h1 className="-mt-2 text-lg font-semibold dark:text-white">Goals Completion </h1>
              <div class="line"></div>
              <div class="flex">
              <div className="flex-1 pl-6">
              <h4 className="pl-20 -mt-3 -mb-2 text-sm  dark:text-white">Total Revenue</h4>
                <img class="ml-4 mt-3" src="src/pages/admin/report/images/Rectangle 252.png" alt="" />
                <h1 className=" pl-24 -mt-12 text-3xl font-semibold dark:text-white">2050000 Birr </h1>
              
              </div>
              <div className="flex-1 pl-6">
              <h4 className="pl-20 -mt-3 -mb-2 text-sm  dark:text-white">Total Cost</h4>
                <img class="ml-4 mt-3" src="src/pages/admin/report/images/Rectangle 253.png" alt="" />
                <h1 className=" pl-24 -mt-12 text-3xl font-semibold dark:text-white">1500000 Birr </h1>
              
              </div>
              <div className="flex-1 pl-6">
              <h4 className="pl-20 -mt-3 -mb-2 text-sm  dark:text-white">Total Profit</h4>
                <img class="ml-4 mt-3" src="src/pages/admin/report/images/Rectangle 254.png" alt="" />
                <h1 className=" pl-24 -mt-12 text-3xl font-semibold dark:text-white">850000 Birr </h1>
          ...
          <div class="layout">
            ...
            <div className=" w-12/12 h-16 flex border rounded-md p-4 bg-blue  shadow-md">
             <div>
      <h1 className="-mt-4 text-lg font-semibold dark:text-white" >Goal Completion</h1>

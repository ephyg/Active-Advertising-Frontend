        ...
        <div id="download-pdf" className="flex flex-col mx-auto w-594 h-562">
          ...
          <div className="">
            <p className="leading-8">
              This agreement is made on {props.agreementDate} between active advertising and {props.clientName}. Agreement for service of on invoice {props.invoiceNo}.
            </p>
            <p className="leading-8">
              Key Terms of agreement: {props.keyTerms}
            </p>
            <p className="leading-8">
              Delivery of service
              <br />
              • Service start date: {props.serviceStartDate}
              <br />
              • Service end date: {props.serviceEndDate}
              <br />
              Price: {props.price}
            </p>
            <p className="leading-9">
              Payment Mode: {props.paymentMode}. General Terms: Payment should be made on time for work to be completed on time.
            </p>
          </div>
          <div className="flex justify-between mt-8">
            <div className="flex flex-col">
              <label className="leading-8">Active Adverting</label>
              <input className="border-b border-black outline-none w-24" value={props.activeAdvert} readOnly />
            </div>
            <div className="flex flex-col">
              <label className="leading-8">Client Name</label>
              <input className="border-b border-black outline-none w-24" value={props.clientName} readOnly />
            </div>
          </div>
        </div>
